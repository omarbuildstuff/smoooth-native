# Contributing to Smoooth

First off, thank you for considering contributing to Smoooth! It's people like you that make open source such a great community.
...
2.  **Clone your fork:** `git clone https://github.com/tamnguyenvan/smoooth.git`
...
9.  **Open a Pull Request:** Go to the original Smoooth repository and open a PR from your forked branch. Please fill out the PR template with as much detail as possible.
