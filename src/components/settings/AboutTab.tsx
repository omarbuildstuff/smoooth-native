...
export function AboutTab() {
  ...
  return (
    <div className="p-8 text-center flex flex-col items-center justify-center h-full">
      <img src="media://smoooth-appicon.png" alt="Smoooth Logo" className="w-24 h-24 mb-4 rounded-3xl shadow-lg" />
      <h2 className="text-2xl font-bold text-foreground">Smoooth</h2>
      <p className="text-sm text-muted-foreground mb-6">Version {appVersion}</p>

      <div className="text-sm text-foreground space-y-2">
        <p>Created with ❤️ by Umar.</p>
        <p>A modern screen recorder and editor designed to be simple and powerful.</p>
      </div>

      <div className="mt-8 flex items-center gap-4">
        <Button variant="secondary" onClick={() => openLink('https://github.com/tamnguyenvan/smoooth')}>
