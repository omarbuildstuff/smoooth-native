tôi đang muốn làm 1 desktop app bằng electron (chủ yếu cho linux, sẽ mở rộng cho windows, macos sau) tên là Smoooth - một screen recorder + edit studio như là Screen Studio. các tính năng:
...
- title bar: từ trái sang gồm có traffic lights -> Smoooth -> Nút export
