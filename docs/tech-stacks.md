# Smoooth - Technology Stack

This document outlines the primary technologies chosen for the development of Smoooth. The stack is selected to facilitate rapid development, ensure cross-platform compatibility, and leverage the modern JavaScript/TypeScript ecosystem.
